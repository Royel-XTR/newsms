...
logo=(green+""" Ｓｈｉｔｈｉｌ Ａｈｍｅｄ""")




line=(yellow+"======================================================================")
tversion=(cyan+"\t\t   Version : 2.890 ")

line2=("\t\t~~~~~~~~~~~~~~~~~~~~~~~~~~")

dtls=(yellow+"\t\t Created By: ꜱʜɪᴛʜɪʟ ᴀʜᴍᴇᴅ ")

note=(cyan+"Note: It's only for fun😍😍.")
...
print('                                 ')
print(cyan+'\t\tThanks For Using Shithil Ahmed/ROYEL"XTR" Tools')